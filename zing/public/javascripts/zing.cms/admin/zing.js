// This is stolen fair and square from rails.js, jQuery edition :)
...
jQuery(function ($) {
    ...
    $('body').delegate('a[data-confirm], button[data-confirm], input[data-confirm]', 'click.zing', function () {
        var el = $(this);
     ...
     * remote handlers
     */
    $('form[data-remote]').live('submit.zing', function (e) {
        $(this).callRemote();
        e.preventDefault();
    });

    $('a[data-remote],input[data-remote]').live('click.zing', function (e) {
        $(this).callRemote();
        e.preventDefault();
    });
    ...
    $(disable_with_form_remote_selector).live('ajax:before.zing', disable_with_input_function);
    $(disable_with_form_not_remote_selector).live('submit.zing', disable_with_input_function);

    $(disable_with_form_remote_selector).live('ajax:complete.zing', function () {
        $(this).find(disable_with_input_selector).each(function () {
            var input = $(this);
